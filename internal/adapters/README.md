...
- delegate view-model formatting to `internal/adapters/inbound/http/presenter` and rendering to `internal/adapters/inbound/http/ui`.

Do not add business rules, repository interfaces, or database/provider details to `internal/adapters/inbound/http`.

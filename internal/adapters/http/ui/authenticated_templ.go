...
func Authenticated(shows []appcatalog.Show, email string, upcoming []SubRequestView, past []SubRequestView, isAdmin bool) templ.Component {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			if len(shows) == 0 {
				...
				for _, show := range shows {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/adapters/http/ui/authenticated.templ`, Line: 26, Col: 27}
					}
					...
					if show.Title != "" {
						...
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/adapters/http/ui/authenticated.templ`, Line: 28, Col: 17}
						}
						...
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/adapters/http/ui/authenticated.templ`, Line: 30, Col: 14}
						}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/adapters/http/ui/authenticated.templ`, Line: 45, Col: 15}
			}
...
func SubRequestTable(subRequests []SubRequestView) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		for _, req := range subRequests {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/adapters/http/ui/authenticated.templ`, Line: 245, Col: 54}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/adapters/http/ui/authenticated.templ`, Line: 246, Col: 36}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/adapters/http/ui/authenticated.templ`, Line: 247, Col: 24}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/adapters/http/ui/authenticated.templ`, Line: 248, Col: 34}
			}
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var14))
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 25, "</td><td rowspan=\"2\" class=\"actions-cell\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			if req.CanDelete {
				...
				var templ_7745c5c3_Var15 templ.ComponentScript = templ.ComponentScript{Call: "deleteRequest('" +
					strconv.Itoa(req.ID) + "')"}
			...
			var templ_7745c5c3_Var18 = []any{templ.KV("row-available", req.TakerEmail == ""), templ.KV("row-taken", req.TakerEmail != "")}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 34, "\"><td style=\"font-size: 0.8rem; color: #666; border-bottom: 1px solid #eee;\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/adapters/http/ui/authenticated.templ`, Line: 273, Col: 94}
			}
			...
			if req.TakerEmail != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/adapters/http/ui/authenticated.templ`, Line: 277, Col: 22}
				}

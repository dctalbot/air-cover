		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			if len(users) == 0 {
				...
				for _, user := range users {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/adapters/inbound/http/ui/admin.templ`, Line: 77, Col: 51}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/adapters/inbound/http/ui/admin.templ`, Line: 78, Col: 24}
					}
					...
					if user.IsEnabled {
						...
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/adapters/inbound/http/ui/admin.templ`, Line: 1, Col: 0}
						}
						...
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/adapters/inbound/http/ui/admin.templ`, Line: 81, Col: 68}
						}
					...
					if user.CanDeactivate {
						...
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/adapters/inbound/http/ui/admin.templ`, Line: 86, Col: 73}
						}
						...
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/adapters/inbound/http/ui/admin.templ`, Line: 87, Col: 93}
						}
						...
						if user.IsEnabled {
							...
							if templ_7745c5c3_Err != nil {
								return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/adapters/inbound/http/ui/admin.templ`, Line: 97, Col: 74}
							}
							...
							if user.Role == "admin" {
								...
								if templ_7745c5c3_Err != nil {
									return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/adapters/inbound/http/ui/admin.templ`, Line: 105, Col: 29}
								}
								...
								if templ_7745c5c3_Err != nil {
									return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/adapters/inbound/http/ui/admin.templ`, Line: 107, Col: 28}
								}
